    ...
    itemColor: function(options){
      ...
      this.each(function() {
          ...
          for(var j = 0; j < layout[i].length; j++) {
            ...
            grid += '<img class="color-select"' +
              ...
              'style="' +
                'width:' + itemWidth + '%; ' +
                'margin:10px;" ' + 
                'src="/static/webapp/images/treasurebox_images/' + color + '.png" />'; 
          }
        }

        var $injectedColor = 
          $('<img style="width:54px;height:66px;" id="color_value" class="value" src="/static/webapp/images/treasurebox_images/'+ $color.val() +'.png"/>' +
          '<div class="clear"></div>' +
        ...
        $item.find('.color-select').on('click', function(ev) {
          ...
          $color.val(value);
          var img_path = '/static/webapp/images/treasurebox_images/' + value + '.png';
