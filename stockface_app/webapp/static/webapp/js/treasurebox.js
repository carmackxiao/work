...
language_select.addEventListener('change', function() {
  ...
  var reset_lang_url = '/webapp/treasurebox_setting?t=2&v=3&watchid=' + watch_id + '&watch_color=' + watch_color_type + '&language=' + language + '&change=1';  
...
submitButton.addEventListener('click', function() {
  ...
  $.ajax({ 
  	type: "GET",
	   url: "/webapp/treasurebox_save?data=" + encodeURIComponent(JSON.stringify(config)),
