...
def expired(request):
	context= {'sn':'123456'}
	return render(request, 'webapp/treasurebox/expired.html', context)
...
def setting(request):
	...
	return render(request, 'webapp/treasurebox/setting.html', context)
...
def save(request):
	...
	return render(request, 'webapp/treasurebox/setting.html')