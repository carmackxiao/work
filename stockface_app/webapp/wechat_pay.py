...
class WxPayConf_pub(object):
    ...
    APPID = "wx7e4dacfaf6ac484f"
    #JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    APPSECRET = "180e5e02fb9a7962ed1281795c9a6973"
    #受理商ID，身份标识
    MCHID = "1376023102"
    #商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    KEY = "17c64494652911e684793c075427c881"
   

    #=======【异步通知url设置】===================================
    #异步通知url，商户根据实际开发过程设定
    NOTIFY_URL = "http://115.28.69.10/webapp/wxpay_notify"
    ...
    #=======【证书路径设置】=====================================
    #证书路径,注意应该填写绝对路径
    # SSLCERT_PATH = "/root/work/stockface_web/wechat/apiclient_cert.pem"
    # SSLKEY_PATH = "/root/work/stockface_web/wechat/apiclient_key.pem"

    #测试证书
    SSLCERT_PATH = "/Users/carmack/work/stockface_web/wechat/apiclient_cert.pem"
    SSLKEY_PATH = "/Users/carmack/work/stockface_web/wechat/apiclient_key.pem"
...
class ShortUrl_pub(Wxpay_client_pub):
    ...
    def getShortUrl(self):
        ...
        self.postXml()
        self.result = self.xmlToArray(self.response)
        shorturl = self.result["short_url"]
        return shorturl
...
class NativeLink_pub(Common_util_pub):
    ...
    def __init__(self):
        self.parameters = {'product_id': '1'} #静态链接参数
...
def get_short_url():
    ...
    short_pub.setParameter('long_url', 'weixin://wxpay/bizpayurl?appid=wx7e4dacfaf6ac484f&mch_id=1376023102&nonce_str=zfhumhjaeygwdmas7wfhvxrkisdolw12&product_id=1&sign=7ABBF92A1A5C27AF5D9B8030F8482E40&time_stamp=1471920393')
    print short_pub.getShortUrl()
